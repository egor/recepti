    ...
    <table class="i-img">
        <tr>
            ...
            <td class="pre-img">
                <?php
                if (!empty($model->img)) {
                    echo '<div id="main-img"><img src="/images/category/' . $model->img . '" width="200px" /><br /><a href="#" onclick="categoryDeletePic(' . $model->category_id . '); return false;" rel="tooltip" title="удалить картинку" class="i-remove"><i class="icon-remove"></i></a></div>';
                } else {
